(self["webpackChunkionic_angular_web3_login"] = self["webpackChunkionic_angular_web3_login"] || []).push([["src_app_dashboard_dashboard_module_ts"],{
...
/* harmony import */ var stop_media_stream__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! stop-media-stream */ 2999);
/* harmony import */ var stop_media_stream__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(stop_media_stream__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _services_alert_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/alert.service */ 5970);
...
let DashboardPage = class DashboardPage {
    constructor(authService, storage, navCtrl, http, loadingController, router, alert) {
    ...
    getcusdata() {
        this.http.post('https://chain.kapacitor.me/custormerdata', { address: this.address })
            ...
            let hours = res.remaintime / 60; //แปลงเป็นชั่วโมง
            let minutes = res.remaintime % 60; //แปลงเป็นนาที
            let seconds = res.remaintime * 60 % 60; // แปลงเป็นวินาที
    ...
    stopStream() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            stop_media_stream__WEBPACK_IMPORTED_MODULE_4___default()(this.stream);
            // this.loading = null;
            // this.scanActive = true;
        });
    }
    ...
    requestAccess() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.http.post('https://enx.bannaisoi.com/requestaccess', body, { headers: headers })
                ...
                if (res.message == 'Out of service') {
                    this.alert.usingAlert("Out of service");
                }
    ...
    test() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            let aaaa = yield this.storage.get('token');
            console.log(aaaa);
        });
    }
};
...
DashboardPage.propDecorators = {
    video: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_11__.ViewChild, args: ['video', { static: false },] }],
    canvas: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_11__.ViewChild, args: ['canvas', { static: false },] }]
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-header>\n  <ion-toolbar color=\"dark\">\n    <ion-title>Dashboard</ion-title>\n    <ion-buttons slot=\"start\">\n      <ion-button (click)=\"logout()\"\n        ><ion-icon slot=\"icon-only\" name=\"power-outline\"></ion-icon\n      ></ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-card>\n    <ion-item>\n      <ion-label>{{address}}</ion-label>\n    </ion-item>\n    <ion-item>\n      <ion-label>Remain Time : {{remaintime}}  {{texttime}}</ion-label>\n    </ion-item>\n    <ion-item>\n      <ion-label>Point : {{point}}</ion-label>\n    </ion-item>\n    \n  </ion-card>\n\n     <!-- Shows our camera stream -->\n     <video #video [hidden]=\"!scanActive\" width=\"100%\" class=\"video ion-no-border\" ></video>\n     <!-- Used to render the camera stream images -->\n     <canvas #canvas hidden></canvas>\n\n  <ion-button  class=\"ion-margin-top ion-margin-bottom\"  shape=\"round\" expand=\"full\"\n  color=\"primary\" (click)=\"startScan()\">QR Scan</ion-button>\n  <!-- <ion-button  class=\"ion-margin-top ion-margin-bottom\"  shape=\"round\" expand=\"full\"\n  color=\"primary\" (click)=\"stopStream()\">stop</ion-button>\n  <ion-button  class=\"ion-margin-top ion-margin-bottom\"  shape=\"round\" expand=\"full\"\n  color=\"primary\" (click)=\"test()\">token</ion-button> -->\n</ion-content>\n");
