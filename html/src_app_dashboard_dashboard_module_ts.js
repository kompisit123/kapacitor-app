...
let DashboardPage = class DashboardPage {
    constructor(authService, storage, navCtrl, http, loadingController, router) {
...
DashboardPage.propDecorators = {
    video: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_10__.ViewChild, args: ['video', { static: false },] }],
    canvas: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_10__.ViewChild, args: ['canvas', { static: false },] }]
};
