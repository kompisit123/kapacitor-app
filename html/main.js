...
let AuthService = class AuthService {
    ...
    signInWithMetaMask() {
        let ethereum;
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)(_metamask_detect_provider__WEBPACK_IMPORTED_MODULE_0___default()()).pipe(
        // Step 1: Request (limited) access to users ethereum account
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)((provider) => (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            if (!provider) {
        ...
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)(() => this.http.post('https://enx.bannaisoi.com/getNonceToSign', {
            address: ethereum.selectedAddress,
        })), 
        // Step 3: Get the user to sign the nonce with their private key
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)((response) => (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
        ...
        (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.switchMap)((sig) => this.http.post('https://enx.bannaisoi.com/verifysign', { address: ethereum.selectedAddress, signature: sig })), 
